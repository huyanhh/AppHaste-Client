...
def main(argv):
    ...
    while not char is 'q':
        ...
        if char == 'g':
            ...
            search = input('Search on Google (what is selenium webdriver)\n>> ')
            ...
            while not char is 'q':
                ...
                char.lower()
                if char == 'i':
                    char = input('Enter the element with ID\n>> ')
                ...
                if char == 'n':
                    char = input('Enter the element with Name\n>> ')
                    if char == "" or len(char) == 0 and browser.element.validateLocator(char) == 0:
                        continue
                ...
                if char == 't':
                    char = input('Enter the element with Tag\n>> ')
                    if char == "" or len(char) == 0 and browser.element.validateLocator(char) == 0:
                        continue
                ...
                if char == 'p':
                    char = input('Enter the element with Partial Text\n>> ')
                    if char == "" or len(char) == 0 and browser.element.validateLocator(char) == 0:
                        continue
                ...
                if char == 'l':
                    char = input('Enter the element with Link Text\n>> ')
                    if char == "" or len(char) == 0 and browser.element.validateLocator(char) == 0:
                        continue
                ...
                if char == 'c':
                    char = input('Enter the element with Classname\n>> ')
                    if char == "" or len(char) == 0 and browser.element.validateLocator(char) == 0:
                        continue
                ...
                if char == 's':
                    char = input('Enter the element with CSS Selector\n>> ')
                    if char == "" or len(char) == 0 and browser.element.validateLocator(char) == 0:
                        continue
                ...
                if char == 'x':
                    char = input('Enter the element with Xpath\n>> ')
                    if char == "" or len(char) == 0 and browser.element.validateLocator(char) == 0:
                        continue
            ...
            while not char is 'q':
                ...
                selection.lower()
                if selection != 'q':
                    locator = input('Enter the locator of the element you seek\n>> ')
                ...
                if elements == 0 or elements == None or not len(elements):
                    ...
                    while not index is '0':
                        index = input('Enter the element index you seek (1-{}) or (0)\n>> '.format(len(elements)))
                        index.lower()
                        try:
                            index = int(index)
                        except ValueError:
            ...
            while not char is 'q':
                ...
                if char == 's':
                    save_name = ""
                    save_name = input('Enter the filename (default leave blank)\n>> ')
                    if save_name == 0 or len(save_name) == 0:
                        save_name = 0
                    browser.screenshot(save_name=save_name)
                elif char == 'p':
                    save_name = input('Enter the filename or leave blank for default\n>> ')
            ...
            size = input('Enter Window Size (w, h)\n>> ')
            ...
            position = input('Enter Window Position (x, y)\n>> ')
            ...
            while not char is 'q':
                ...
                if char == 'c':
                    ...
                    if browser.selectedElement == None or not isinstance(browser.selectedElement, WebElement):
                        print("No Web element been selected")
                        continue
                    text = input('Enter your text to send\n>> ')
            ...
            while not char is 'q':
                ...
                char.lower()
                if char == 's':
                    x = input('Enter scroll point in X direction (int)\n>> ')
                    try:
                        scroll = int(x)
                    except ValueError:
                        print("Value Error: {} Invalid entry for integer. \nInput numerical value".format(x))
                        continue
                    y = input('Enter scroll point in Y direction (int)\n>> ')
                    try:
                        y = int(y)
                    except ValueError:
